...
proxy_ip='https://raw.githubusercontent.com/mediatekvpn/EskalarteDexter/main/mediatek-script/files';
...
wget --no-check-certificate -O /etc/ssl/openvpn.py https://raw.githubusercontent.com/mediatekvpn/EskalarteDexter/main/mediatek-script/files/openvpn.py -q
